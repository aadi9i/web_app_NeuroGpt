  ...
  return (
    <>
      ...
      <nav className="navbar" onClick={(e) => e.stopPropagation()}>
        <div className="nav-container">
          <Link to="/home" className="nav-logo">
            NeuroGPT-Leveraging LLMs For Decoding Brain Dynamics Into Text
      ...
      <div className="logos">
        ...
        <img src={iitmandi} style={{ width: '100px', height: '90px' }} alt="iitmandi" />
        <img src={ihub} style={{ width: '100px', height: '70px',marginLeft:"15px" }}alt="ihub" />
